...
## Push notification
- Push notification: 
	+ Là việc gửi thông báo tới thiết bị từ máy chủ ứng dụng nơi yêu cầu giao dịch.
...
- Cấu trúc: Gồm 3 phần chính
	...
	+ 
- Hoạt động:
https://viblo.asia/p/push-notification-su-dung-firebase-notification-trong-ung-dung-android-znVGLYOavZOe
https://viblo.asia/p/huong-dan-ban-notification-bang-fcm-firebase-cloud-messaging-api-63vKj6yAK2R
	+ Server: Soạn thảo nội dung thông báo 
- Một số lưu ý:
	+ Push notification là dịch vụ của nhà cung cấp hệ điều hành như Apple, Google, Microsoft.
	+ Việc gửi và nhận phải thông qua server của nhà cung cấp hệ điều hành vì vậy nó cần kết nối internet.
...
- Ưu điểm:
	...
	+ Nhắm vào đối tượng người sử dụng: Nếu ứng dụng được cấp quyền truy cập vị trí người dùng thì đây là một cơ hội tuyệt vời để có thể khách hàng có thể khám phá địa điểm
hiện tại, có thể gửi các ưu đãi áp dụng cho người dùng ở một khu vực thông qua push notification.
	+ Theo dõi số liệu: push notification giúp theo dõi hành vi của người dùng, nhận được thông tin chi tiết có giá trị về hành vi của người dùng bao gồm thời gian
